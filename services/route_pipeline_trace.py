...
COUNTER_KEYS = (
    ...
    "route_visible_relaxed_candidates_count",
...
STATUS_KEYS = (
    ...
    "fallback_route_visible_relaxed_used",
...
def route_debug_summary(route_id: str, trace: list[dict[str, Any]] | None) -> dict[str, Any]:
    ...
    return {
        ...
        "retrieval": {
            ...
            "route_visible_relaxed_candidates_count": _pick_number(retrieval, "route_visible_relaxed_candidates_count"),
            ...
            "location_fallback_applied": retrieval.get("location_fallback_applied") or candidate_retrieval.get("location_fallback_applied"),
            "location_fallback_reason": retrieval.get("location_fallback_reason") or candidate_retrieval.get("location_fallback_reason"),
            "original_start_point": retrieval.get("original_start_point") or candidate_retrieval.get("original_start_point"),
            "city_center_location": retrieval.get("city_center_location") or candidate_retrieval.get("city_center_location"),
            "distance_to_city_center_meters": retrieval.get("distance_to_city_center_meters") or candidate_retrieval.get("distance_to_city_center_meters"),
        },
        "city": {
