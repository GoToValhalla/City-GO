...
def test_public_city_catalog_requires_explicit_city_publication(db_session, city_factory) -> None:
...
def test_public_city_catalog_is_not_split_by_web_and_telegram_feature_flags(db_session, city_factory) -> None:
