...
class TestAlembicSingleHead(unittest.TestCase):
 ...
 def test_known_head_revision(self):self.assertIn("a1b2c3d4e5f6",_script().get_heads())
 ...
 def test_total_revision_count(self):self.assertEqual(sum(1 for _ in _script().walk_revisions()),55)
