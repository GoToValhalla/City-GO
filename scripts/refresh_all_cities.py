#!/usr/bin/env python3
"""Refresh all enabled city import scopes and send an operations report.

The script is designed to run inside the production backend container. It uses the
existing OSM importer and Data Coverage Assurance service, then reports per-city
before/after catalogue metrics to Telegram.
"""
