...
def main() -> None:
    ...
    parser.add_argument("--confirm", action="store_true", help="Required together with --apply or --rollback-audit-ids.")
    ...
    if args.apply and args.rollback_audit_ids:
        raise SystemExit("Choose either --apply or --rollback-audit-ids.")
    if (args.apply or args.rollback_audit_ids) and not args.confirm:
