...
| [`admin_operational_center.md`](admin_operational_center.md) | City Workspace, quality dashboard, system health, analytics, alert lifecycle и action state contract. |
